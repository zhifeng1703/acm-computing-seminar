...
|                    |                                                                                                     |
|                    | Note that in this simple case, you may not obtain a nice straight line to indicate the convergence  |
|                    | rate. Since quadratic convergence in 1 dimension problem is way too fast. The convergent sequence   |
|                    | is short and the numeric error comes in too early. However, you can still comment on the magnitude, |
